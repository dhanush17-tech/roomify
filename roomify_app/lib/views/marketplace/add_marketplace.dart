...
class AddMarketplaceScreen extends StatefulWidget {
  ...
  AddMarketplaceScreen({this.existingListing});
...
class _AddMarketplaceScreenState extends State<AddMarketplaceScreen> {
        ...
        Wrap(
          ...
          children: [
            ..._existingImageUrls.asMap().entries.map(
                  (entry) => _buildExistingImagePreview(entry.value, entry.key),
                ),
  ...
  void initState() {
    ...
    if (widget.existingListing != null) {
      ...
      _latitude = widget.existingListing!.latitude ?? 0.0;
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    widget.existingListing != null ? "Edit Item" : "Add Item",
                    style: TextStyle(
                      color: orangeColor,
                      fontWeight: FontWeight.bold,
                      fontSize: 25,
